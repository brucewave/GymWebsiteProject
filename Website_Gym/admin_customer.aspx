<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="admin_customer.aspx.cs" Inherits="Website_Gym.admin_customer" %>
          ...
          <div class="d-flex justify-content-between">
            <div class="col-auto">
              <div class="position-relative">
                <h1 class="">Table of Customers</h1>
              </div>
            </div>
            <div class="col-auto">
              <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                <button class="btn btn-filter px-4"><i class="bi bi-box-arrow-right me-2"></i>Export</button>
                <button class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i> <a href="#instructorInformation"
                    class="text-white">Add Customers</a></button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <form action="" id="instructorInformation">
            <div class="card-body p-4">
              ...
              <div class="row mb-3">
                <label for="input46" class="col-sm-3 col-form-label">Select Instructor</label>
                <div class="col-sm-9">
                  <select class="form-select" id="input46">
